...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="action/User_Forgot_Password_Post.php" method="post">
        <div class="input-group mb-3">
          <input type="email" name="UserEmail" class="form-control" placeholder="Email" autocomplete="off" required>
      ...
      <i class="fa fa-user"></i>
        <a href="User_Create.php" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
