...
// $user_id = (isset($_GET['id']) && ($_GET['id']!="") && ($_GET['id']!="X") )?$_GET['UserId']:$search_id;
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="network_tree_search.php?id=">Home</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="#" method="post">
                ...
                <input type="text" class="form-control" placeholder="Agent Id" name="AgentId" required autocomplete="off" >
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">View Network Tree</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<div class="tooltips">
  <div class="myDIV">
        <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[0]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[0]['UserId'];?>" 
...
<li>
    <div class="tooltips1">
    <div class="myDIV">
      <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[1]['UserId']?>">-->
      <!--<?php //echo $tree_data[1]['UserId'] ?></a>-->
        <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[1]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[1]['UserId'];?>" 
...
<ul>
            <li>
                <div class="tooltips3">
                <div class="myDIV">
                <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[3]['UserId'] ?>"><?php //echo $tree_data[3]['UserId'] ?></a>-->
                <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[3]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[3]['UserId'];?>" 
            ...
            <li >
                <div class="tooltips7">
                <div class="myDIV">
                  <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[7]['UserId'] ?>"><?php //echo $tree_data[7]['UserId'] ?></a>-->
                  <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[7]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[7]['UserId'];?>" 
...
<div class="tooltips8">
  <div class="myDIV">
    <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[8]['UserId'] ?>">-->
    <!--<?php //echo $tree_data[8]['UserId'] ?></a>-->
     <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[8]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[8]['UserId'];?>" 
...
<li>
   <div class="tooltips4">
    <div class="myDIV">
    <!--  <a href="network_tree_search.php?id=<?php //echo $tree_data[4]['UserId'] ?>">-->
    <!--<?php //echo $tree_data[4]['UserId'] ?></a>-->
     <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[4]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[4]['UserId'];?>" 
     ...
     "><img class="img-fluid img-circle" src="image/profile.jpg" width="50px" height="50px"><br><?php echo $tree_data[4]['UserId'];?></a>
            ...
            <li>
                <div class="tooltips9">
                  <div class="myDIV">
                  <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[9]['UserId'] ?>">-->
                  <!--<?php //echo $tree_data[9]['UserId'] ?></a>-->
                  <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[9]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[9]['UserId'];?>" 
...
<li>
   <div class="tooltips10">
    <div class="myDIV">
    <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[10]['UserId'] ?>">-->
    <!--<?php //echo $tree_data[10]['UserId'] ?></a>-->
    <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[10]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[10]['UserId'];?>" 
...
<li>
    <div class="tooltips2">
    <div class="myDIV">
      <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[2]['UserId'] ?>">-->
      <!--<?php //echo $tree_data[2]['UserId'] ?></a>-->
     <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[2]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[2]['UserId'];?>" 
...
<ul>
            ...
            <div class="myDIV">  
            <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[5]['UserId'] ?>">-->
            <!--<?php //echo $tree_data[5]['UserId'] ?></a>-->
             <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[5]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[5]['UserId'];?>" 
            ...
            <div class="myDIV"> 
                 <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[11]['UserId'] ?>">-->
                 <!--<?php //echo $tree_data[11]['UserId'] ?></a>-->
                 <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[11]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[11]['UserId'];?>" 
...
<li>
    ...
    <div class="myDIV">  
    <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[12]['UserId'] ?>">-->
    <!--<?php //echo $tree_data[12]['UserId'] ?></a>-->
    <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[12]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[12]['UserId'];?>" 
...
<div class="tooltips6">
  <div class="myDIV">
  <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[6]['UserId'] ?>">-->
  <!--<?php //echo $tree_data[6]['UserId'] ?></a>-->
 <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[6]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[6]['UserId'];?>" 
...
<div class="tooltips13">
  <div class="myDIV">
  <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[13]['UserId'] ?>">-->
  <!--<?php //echo $tree_data[13]['UserId'] ?></a>-->
   <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[13]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[13]['UserId'];?>" 
...
<div class="tooltips14">
  <div classs="myDIV">
  <!--<a href="network_tree_search.php?id=<?php //echo $tree_data[14]['UserId'] ?>">-->
  <!--<?php //echo $tree_data[14]['UserId'] ?></a>-->
     <a class="bg-warning" href="network_tree_search.php?id=<?php $tree_data[14]['UserId'] ?>" data-toggle="popover" data-placement="right" data-trigger="hover" data-html="true" title="ID- <?php echo $tree_data[14]['UserId'];?>" 
