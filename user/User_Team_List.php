<?php
//This page is used by agent and it collect the details of Team whose Members_usertype=5 and userId=agent Id. This is for team.
include "include/header.php";
$token=$_SESSION['token'];
$url = $URL."User_Members/User_DirectMembers_List.php";
$LoginUserRole=$_SESSION['login_session']->userRole;
$UserId=$_SESSION['login_session']->UserId;
$Member_UserType=5;
$data = array("UserId"=>$UserId,"Member_UserType"=>$Member_UserType);
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Direct Customer List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo $value1->AgentName ?> </td>
