<?php
//This page is used by Admin and this is listing of all the approved Members.
include "include/header.php";
$token=$_SESSION['token'];
$url = $URL."User_Members/Users_MembersApprovedList.php";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Members List List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                    ...
                    <tr>
                     ...
                     echo $date1[0] ?></td>
                     <td><?php  $date1=explode(' ',$value1->ApprovedOn);
                     echo $date1[0] ?></td>
