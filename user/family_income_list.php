...
$url = $URL."income/family_income_read.php";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Family Income</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Family Income</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <div class="card card-primary">
              ...
              <h3 class="card-title">Family Income</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <?php }else{?>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo $value1->level_name ?> </td>
                      <td><?php echo $value1->user_income ?> </td>
