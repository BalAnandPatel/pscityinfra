...
$customer_payment_update->MemberIncomeFlag=$data->MemberIncomeFlag;  
...

{
    ...
    if($customer_payment_update->updateTeamIncomeFlag()){
  
        // set response code - 201 created
        http_response_code(201);
  
        // tell the user
        echo json_encode(array("message" => "Team Income flag updated."));
    }
    ...
    // if unable to create the purchage_plot, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to update Team Income Flag."));
