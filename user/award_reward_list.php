...
$url = $URL."awardReward/Award_Reward_read.php";
$data = array( "id" => 1);
                ...
                <?php// }else{?>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo $value1->RewardAccessories ?> </td>
                      <td><?php echo $value1->AwardName ?> </td>
                      <td><?php echo $value1->AmountUpto ?> </td>
                      <td><?php echo $value1->RankPercentage ?></td>
					            <td><?php echo $value1->FamilySupportBonus ?></td>
					            <td><?php echo $value1->RewardDuration ?></td>
