...
$url = $URL . "Members_Payment/Total_PaymentByMemberId.php";
      ...
      <div class="invoice">
         ...
         <div class="invoice-header">
            <div class="invoice-from">
               <strong class="text-inverse"><small>Company Detail</small></strong>
            ...
            <div class="invoice-to">
               <strong class="text-inverse"></small>Customer Detial</small></strong>
               <address class="m-t-5 m-b-5">
                  <table>
            ...
            <div class="invoice-to">
               ...
               <address class="m-t-5 m-b-5">
                  <table>
                     ...
                     <tr><td><small>Section/Plot No :</td><td><?php echo ucfirst($value1->SiteSection);?>/<?php echo ucfirst($value1->PlotNo);?></td></tr>
            ...
            <div class="invoice-date">
               <strong class="text-inverse">Invoice / Detail</strong>
               <div class="date text-inverse m-t-5"><small>Invoice Date:</small><?php echo $time = date("d/m/Y h:i:s",$value1->PurchasedOn)?></div>
               <div class="date text-inverse m-t-5"><small>Invoice Number:</small> <?php echo $value1->PurchaseInvoiceId; ?></div>
               <div class="date text-inverse m-t-5"><small>Receipt Number: </small><?php echo $value1->ReceiptNo; ?></div>
             </div>
               ...
               <table class="table table-sm table-invoice">
                  ...
                  <?php 
                   ...
                   <td>
                        ...
                        <td class="text-right"><i class="fa fa-rupee text-muted" style="font-size:12px;"></i> <?php echo $value1->SitePurchaseAmount ?></td>
                   </tr>
                   ...
                   <td>
                        ...
                        <td class="text-right"><i class="fa fa-rupee text-muted" style="font-size:12px;"></i><?php echo $value1->PurchaseAmountPaid; ?></td>
                   </tr>
                   <tr>
                   ...
                   <td>
                        ...
                        <td>
                          ...
                          <?php 
                           $number=$value1->PurchaseAmountPaid;
                           $no = floor($number);
                   ...
                   <td>
                        ...
                        <td class="text-right">  <i class="fa fa-rupee text-muted" style="font-size:12px;"></i> <?php echo $value1->PurchaseAmountLeft; ?></td>
                   </tr>
                   <?php
                     }
                    }
