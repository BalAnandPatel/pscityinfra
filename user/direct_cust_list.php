...
$url = $URL."customer/customer_read_by_agent.php";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Direct Customer List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <div class="card card-primary">
              ...
              <h3 class="card-title">Direct Customer List </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <?php }else{?>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><?php echo $value1->c_name ?> </td>
					            <td><?php echo $value1->mobile ?></td>
                      <td><?php echo $value1->plot_paid_amount ?></td>
                      <td><?php echo $value1->left_amount ?> </td>
