...
$UserType=3;
$Status='0';
$data = array( "UserType"=>$UserType, "Status"=>$Status);
//print_r($data);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pending Agent List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Pending Agent List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <div class="card card-primary">
              ...
              <h3 class="card-title">Pending Agent List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                        <form action="action/user_list_pending_post.php" method="post">
                        <input type="hidden" name="UserId" value="<?php echo $value1->UserId; ?>">
                        <button type="submit" name="submit" class="btn btn-success" type="button">Approve</button>
                        </form>
                      </td>
                    </tr>
                    <?php
