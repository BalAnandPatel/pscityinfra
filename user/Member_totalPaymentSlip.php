<?php
//This is the slip generation page used by Admin to view total payment of all the customer.
include "include/header.php";
$url = $URL . "Members_Payment/Total_PaymentReadByInvoice.php";
//$url = $URL . "plot/site_name_update";
$PurchaseInvoiceId=$_GET['Inv_Id'];
            ...
            <div class="invoice-to">
               ...
               <address class="m-t-5 m-b-5">
                  <table>
                     ...
                     <tr><td><small>Section/Plot No :</td><td> <?php echo ucfirst($value1->SitePurchaseSection);?>/<?php echo ucfirst($value1->PlotNo);?></td></tr>
               ...
               <table class="table table-sm table-invoice">
                  ...
                  <?php 
                   ...
                   <td>
                        ...
                        <td>
                           <span class="text-inverse">Plot Value(Per Sq. Feet)</span><br>
                          </td>
                        <td class="text-right"><i class="fa fa-rupee text-muted" style="font-size:12px;"></i> <?php echo $value1->SitePricePerSquareFeet?></td>
                   </tr>
                   <tr>
