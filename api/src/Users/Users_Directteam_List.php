...
$stmt = $UserDetails->Users_Direct_Team();
// query products
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "User Direct Team not found. Data is incomplete."));
    $log_msg="User Direct Team not found. Data is incomplete. : " . basename($_SERVER['PHP_SELF']);
    logger($log_msg);
 }
 }
 catch (Exception $e){
