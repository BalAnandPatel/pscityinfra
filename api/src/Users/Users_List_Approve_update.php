...

{
   ...
   $User_Profile_update->UpdatedOn = $data->UpdatedOn;
    ...
    // $stmt=$User_Profile_update->validateSponsor();
      ...
      if($User_Profile_update->Users_List_Update()){
  
        // set response code - 201 created
        http_response_code(201);
  
        // tell the user
        echo json_encode(array("message" => "Users list Updated Successfully"));
    }
    ...
    // if unable to create the rankincome, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to update Users list."));
...
// tell the user data is incomplete
    ...
    // tell the user
    echo json_encode(array("message" => "Unable to update users list. Data is incomplete."));
