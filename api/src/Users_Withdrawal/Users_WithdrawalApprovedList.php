...
$UserWithdrawal->WithdrawalStatus= $data->WithdrawalStatus; 
...
$stmt = $UserWithdrawal->Users_WithdrawalApprovedList();
// query products
...
if($num>0 ){
    ...
    echo json_encode(
        array("message" => "User Withdrwal Approved List not Found.")
    );
    $log_msg="User Withdrwal Approved List not Found. : " . basename($_SERVER['PHP_SELF']);
    logger($log_msg);
 }
 }
 catch (Exception $e){
